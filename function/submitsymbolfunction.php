...
$query="insert into tbl_priority(pr_name,pr_symbolno,pr_rank,pr_contact,pr_school,pr_firstp,pr_secondp,pr_thirdp,pr_prform)
         values ('$prName', '$prSNO', '$prRank','$prContact', '$prSchool','$prFirst','$prSecond', '$prThird', '$formName')";
       // echo $query;
