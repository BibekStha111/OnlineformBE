                    ...
                    <div class="row">
                        ...
                        <div class="row">
                         ...
                         <div class="form-group col-md-4">
                          ...
                          <p><?php echo $selectedStudent["st_gender"];?></p>
                         </div>
                          <div class="form-group col-md-4">
                          <label for="exampleInputPassword1">School Type</label>
                          <p><?php echo $selectedStudent["st_scltype"];?></p>
                         </div>
                          <div class="form-group col-md-4">
                          <label for="exampleInputPassword1">Religion</label>
                          <p><?php echo $selectedStudent["st_religion"];?></p>
                         </div>
                          <div class="form-group col-md-4">
                          <label for="exampleInputPassword1">Ethnicity</label>
                          <p><?php echo $selectedStudent["st_ethnicity"];?></p>
                         </div>
                         <center>
                         <table border="1">
                         ...
                         <div class="form-group col-md-4">
                        <tr><td>     
                          <label for="exampleInputPassword1">Marks of English</label>
                          <p><?php echo $selectedStudent["st_meng"];?></p>
                         </div></td><td>
                          <div class="form-group col-md-4">
                          <label for="exampleInputPassword1">Marks of Mathematics</label>
                          <p><?php echo $selectedStudent["st_mmath"];?></p>
                         </div></td><td>
                          <div class="form-group col-md-4">
                          <label for="exampleInputPassword1">Marks of Science</label>
                          <p><?php echo $selectedStudent["st_msci"];?></p>
                         </div></td></tr></table>
</center>
                        </div>
                        <div class="row">
                           ...
                           <div class="col-md-4">
                             ...
                             <div class="gallery">
                              <a target="_blank" href="../../uploads/<?php echo $selectedStudent["st_gradesheet"];?>.png">
                                ...
                                <div class="desc">SEE/Pre-Diploma Marksheet</div>
                            </div>
                           </div>
                            ...
                            <div class="col-md-4">
                             ...
                             <div class="gallery">
                              <a target="_blank" href="../../uploads/<?php echo $selectedStudent["st_gradesheetxii"];?>.png">
                                ...
                                <div class="desc">Character Certificate</div>
                            </div>
                           </div>
                           ...
                           <div class="col-md-4">
                             ...
                             <div class="gallery">
                              <a target="_blank" href="../../uploads/<?php echo $selectedStudent["st_dle"];?>.png">
                                <img class="img img-responsive img-thumnail" src="../../uploads/<?php echo $selectedStudent["st_dle"];?>.png"/>
                              </a>
                                <div class="desc">BLE/DLE Certificate</div>
                            </div>
                           </div>
