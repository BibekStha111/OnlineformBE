...
<html lang="en">
    ...
    <body style="width: 8.5in;">
         ...
         <?php foreach ($verifiedStudents as $row) {
            ...
            echo 
            '<div style="margin-top: 8px; min-height:100%;" >
                       ...
                       <tr>
                         <td>';
                                echo'<img src="../../uploads/'.$row["st_photo"].'.png" style="width: 180px;"> <br/>
                                        ...
                                        echo '<p style="width: 150px;margin-top: -55px; margin-left: 150px; justify-content:right"> Verified By <br/> Deepak Gautam <br/>  Examination Officer <br/> MBMAN </p></td> 
